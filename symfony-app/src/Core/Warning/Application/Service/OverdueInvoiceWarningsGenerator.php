...
final class OverdueInvoiceWarningsGenerator implements WarningsGeneratorInterface
{
    public function __construct(
        private readonly OverdueInvoiceWarningsFetcherInterface $fetcher,
    ...
    public function generate(): GeneratorOutput
    {
        ...
        return new GeneratorOutput(
            type: WarningType::OVERDUE_INVOICE,
